...
in {
  haskell-nix = super.haskell-nix // {
    ...
    compiler =
		...
		++ self.lib.optional (version == "8.6.4")                             ./patches/ghc/ghc-8.6.4-prim-no-arm-atomics.patch
		++ self.lib.optional (version == "8.6.4")                             ./patches/ghc/global-offset-table.patch
                ++ self.lib.optional (version == "8.6.4")                             ./patches/ghc/global-offset-table-2.patch
                ;
        in ({
