  ...
  pkgs = hackage:
    {
      packages = {
        ...
        "haskeline".revision = (((hackage."haskeline")."0.8.0.0").revisions).default;
        ...
        "text-metrics".revision = (((hackage."text-metrics")."0.3.1").revisions).default;
        ...
        "microlens-aeson".revision = (((hackage."microlens-aeson")."2.4.0").revisions).default;
        ...
        "aeson".revision = (((hackage."aeson")."2.0.1.0").revisions).default;
        ...
        "hpack".revision = (((hackage."hpack")."0.34.5").revisions).default;
        ...
        "hnix".revision = (((hackage."hnix")."0.14.0.5").revisions).default;
