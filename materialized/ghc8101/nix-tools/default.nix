  ...
  pkgs = hackage:
    {
      packages = {
        ...
        "hnix".revision = (((hackage."hnix")."0.11.1").revisions).default;
        ...
        "saltine".revision = (((hackage."saltine")."0.1.0.2").revisions).default;
        ...
        "hnix-store-core".revision = (((hackage."hnix-store-core")."0.4.0.0").revisions).default;
        ...
        "hpack".revision = (((hackage."hpack")."0.34.3").revisions).default;
