  ...
  , ... }:
  {
    ...
    components = {
      "library" = {
        ...
        build-tools = [
          (hsPkgs.pkgsBuildBuild.alex or (pkgs.pkgsBuildBuild.alex or (errorHandler.buildToolDepError "alex")))
          (hsPkgs.pkgsBuildBuild.happy or (pkgs.pkgsBuildBuild.happy or (errorHandler.buildToolDepError "happy")))
          ];
        buildable = true;
        modules = [
          "GhcPrelude"
