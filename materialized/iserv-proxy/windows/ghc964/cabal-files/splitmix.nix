{ system
  ...
  ({
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "splitmix"; version = "0.1.0.5"; };
      ...
      benchmarks = {
        ...
        "range" = {
          depends = [
            ...
            (hsPkgs."random" or (errorHandler.buildDepError "random"))
            (hsPkgs."splitmix" or (errorHandler.buildDepError "splitmix"))
            ] ++ (pkgs.lib).optional (!(compiler.isGhcjs && true)) (hsPkgs."clock" or (errorHandler.buildDepError "clock"));
          buildable = true;
          };
        };
      };
    ...
    src = (pkgs.lib).mkDefault (pkgs.fetchurl {
      url = "http://hackage.haskell.org/package/splitmix-0.1.0.5.tar.gz";
