  ...
  pkgs = hackage:
    {
      packages = {
        ...
        libiserv.revision = hackage.libiserv."9.6.1".revisions.default;
        ...
        ghc-boot-th.revision = hackage.ghc-boot-th."9.6.1".revisions.default;
        ...
        ghci.revision = hackage.ghci."9.6.1".revisions.default;
        exceptions.revision = hackage.exceptions."0.10.7".revisions.default;
        ghc-heap.revision = hackage.ghc-heap."9.6.1".revisions.default;
        deepseq.revision = hackage.deepseq."1.4.8.1".revisions.default;
        ghc-boot.revision = hackage.ghc-boot."9.6.1".revisions.default;
