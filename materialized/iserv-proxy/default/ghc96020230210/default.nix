  ...
  pkgs = hackage:
    {
      packages = {
        ...
        directory.revision = (((hackage.directory)."1.3.8.0").revisions).default;
        filepath.revision = (((hackage.filepath)."1.4.100.0").revisions).default;
        ...
        ghc-heap.revision = (((hackage.ghc-heap)."9.6.0.20230210").revisions).default;
        ...
        ghci.revision = (((hackage.ghci)."9.6.0.20230210").revisions).default;
        ...
        ghc-boot.revision = (((hackage.ghc-boot)."9.6.0.20230210").revisions).default;
        process.revision = (((hackage.process)."1.6.16.0").revisions).default;
        unix.revision = (((hackage.unix)."2.8.0.0").revisions).default;
        transformers.revision = (((hackage.transformers)."0.6.1.0").revisions).default;
        libiserv.revision = (((hackage.libiserv)."9.6.0.20230210").revisions).default;
        array.revision = (((hackage.array)."0.5.4.0").revisions).default;
        ghc-boot-th.revision = (((hackage.ghc-boot-th)."9.6.0.20230210").revisions).default;
        pretty.revision = (((hackage.pretty)."1.1.3.6").revisions).default;
        };
      compiler = {
        version = "9.6.0.20230210";
        nix-name = "ghc96020230210";
        packages = {
          "ghc-boot" = "9.6.0.20230210";
          "pretty" = "1.1.3.6";
          "array" = "0.5.4.0";
          "mtl" = "2.3.1";
          "bytestring" = "0.11.4.0";
          "filepath" = "1.4.100.0";
          "stm" = "2.5.1.0";
          "ghc-heap" = "9.6.0.20230210";
          "ghc-prim" = "0.10.0";
          "ghc-boot-th" = "9.6.0.20230210";
          "base" = "4.18.0.0";
          "time" = "1.12.2";
          "process" = "1.6.16.0";
          "ghc-bignum" = "1.3";
