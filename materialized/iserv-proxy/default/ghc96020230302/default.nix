  ...
  pkgs = hackage:
    {
      packages = {
        ...
        ghci.revision = (((hackage.ghci)."9.6.0.20230302").revisions).default;
        ...
        ghc-boot.revision = (((hackage.ghc-boot)."9.6.0.20230302").revisions).default;
        ...
        libiserv.revision = (((hackage.libiserv)."9.6.0.20230302").revisions).default;
