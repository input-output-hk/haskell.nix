  ...
  pkgs = hackage:
    {
      packages = {
        ...
        libiserv.revision = hackage.libiserv."9.4.1".revisions.default;
        ...
        ghc-boot-th.revision = hackage.ghc-boot-th."9.4.1".revisions.default;
        ...
        ghci.revision = hackage.ghci."9.4.1".revisions.default;
        ghc-heap.revision = hackage.ghc-heap."9.4.1".revisions.default;
        deepseq.revision = hackage.deepseq."1.4.8.0".revisions.default;
        ghc-boot.revision = hackage.ghc-boot."9.4.1".revisions.default;
