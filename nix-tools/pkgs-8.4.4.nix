  ...
  pkgs = hackage:
    {
      packages = {
        ...
        "invariant".revision = (((hackage."invariant")."0.5.2").revisions).default;
        ...
        "deriving-compat".revision = (((hackage."deriving-compat")."0.5.5").revisions).default;
        ...
        "th-lift".revision = (((hackage."th-lift")."0.8").revisions).default;
