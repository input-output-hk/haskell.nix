hackage:
  {
    packages = {
      ...
      "tasty-quickcheck".revision = (((hackage."tasty-quickcheck")."0.10").revisions).default;
      ...
      "hspec-discover".revision = (((hackage."hspec-discover")."2.6.1").revisions).default;
      ...
      "mono-traversable".revision = (((hackage."mono-traversable")."1.0.10.0").revisions).default;
