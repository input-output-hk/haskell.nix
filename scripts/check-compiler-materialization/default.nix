...
in builtins.listToAttrs (builtins.concatMap (system: builtins.concatMap (compiler-nix-name:
  ...
  { name = "${prefix}-hello-arm-musl";     value = pkgs.pkgsCross.aarch64-multiplatform-musl.haskell-nix.tool compiler-nix-name "hello" {}; }
        ...
        (system == "x86_64-linux"   && __elem compiler-nix-name ["ghc865" "ghc884" "ghc8105" "ghc8106" "ghc8107" "ghc961" "ghc962" "ghc963" "ghc964" "ghc981" "ghc982" "ghc9820230704"])
     || (system == "aarch64-linux"  && __elem compiler-nix-name ["ghc961" "ghc962" "ghc963" "ghc964" "ghc981" "ghc982" "ghc9820230704"])
     || (system == "x86_64-darwin"  && __elem compiler-nix-name ["ghc8107" "ghc961" "ghc962" "ghc963" "ghc964" "ghc981" "ghc982" "ghc9820230704"])
     || (system == "aarch64-darwin" && __elem compiler-nix-name ["ghc961" "ghc962" "ghc963" "ghc964" "ghc981" "ghc982" "ghc9820230704"])) [
